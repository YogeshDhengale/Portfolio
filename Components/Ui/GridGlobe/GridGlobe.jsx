...
const GridGlobe = () => {
    ...
    return (
        ...
        // change absolute -left-5 top-36, add size-full md:top-40
        <div className="flex-center absolute left-0 top-0 w-full h-96" style={{ height: "24rem" }}>
            <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full px-4">
                <div className="absolute w-full bottom-0 inset-x-0 h-40 bg-gradient-to-b pointer-events-none select-none from-transparent dark:to-black to-white z-40" />
                {/* remove -bottom-20 */}
                <div className="absolute size-full md:h-full">
